...
var collectionTemplate = "## {{ modelName }} Collection [/{{apiVersion}}/{{database}}/{{ urlName }}/{?count,fields,filter,sort}]\n\n";

var collectionListTemplate = "### GET\n\n";
    collectionListTemplate += "Returns an array of {{ pluralizedName }}.\n\n";
    collectionListTemplate += "+ Parameters\n";
    collectionListTemplate += "    + count: `20` (number, optional) - Maximum number of results to retrieve\n";
    collectionListTemplate += '    + fields: `{"name":1}` (object, optional) - Maximum number of results to retrieve\n';
    collectionListTemplate += '    + filter: `{"name":"string to search for"}` (object, optional) - Maximum number of results to retrieve\n';
    collectionListTemplate += '    + sort: `{"created_at":-1}` (object, optional) - Maximum number of results to retrieve\n\n';
