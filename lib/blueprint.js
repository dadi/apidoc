...
var collectionListTemplate = "### GET\n\n";
    ...
    collectionListTemplate += '    + filter: `{"name":"string to search for"}` (object, optional) - Specifies a query to limit the results\n';
    collectionListTemplate += '    + fields: `{"name":1}` (object, optional) - Limits the fields to return\n';
